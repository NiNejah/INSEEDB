...
generateCsvFile('./csv/original/commune.csv',[1,3],'./csv/fill/fill_departement_chefLieu.csv',colDeleteIndex=0,notDeleteDesreption="COM",deleteHeader=True)

# # For RegionChefLieu chefLieu table
generateCsvFile('./csv/original/commune.csv',[1,2],'./csv/fill/fill_region_chefLieu.csv',colDeleteIndex=0,notDeleteDesreption="COM",deleteHeader=True)
